...
import { createPaymentSession, initiatePayment, verifyPayment } from '@/lib/cashfree';
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="bg-duo-bg-purple">
          <div className="text-center">
            <h2 className="text-lg font-medium text-duo-text-primary mb-2">My DuoBalance</h2>
            <div className="flex items-center justify-center space-x-2">
              <span className="text-3xl">₹</span>
              <span className="text-4xl font-bold text-duo-text-primary">{user.coins || '0'}</span>
            </div>
          ...
          <Card.Content>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-5 gap-2">
                  {quickAmounts.map((quickAmount) => (
                    <Button
                      ...
                      className={amount === quickAmount.toString() ? 'bg-duo-primary text-white' : ''}
                    >
                      ₹{quickAmount}
                    </Button>
                  ))}
              ...
              <div className="bg-duo-bg-gray p-4 rounded-lg">
                <h4 className="font-medium text-duo-text-primary mb-2">Accepted Payment Methods</h4>
              ...
              <Button
                ...
                className="w-full"
              >
                {paymentLoading ? 'Processing Payment...' : `Add ₹${amount || '0'} to Wallet`}
              </Button>
            </div>
          </Card.Content>
        </Card>
        ...
        <Card className="border-l-4 border-l-green-500">
          <Card.Content>
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-duo-text-primary">100% Secure Payments</h4>
                <p className="text-sm text-duo-text-secondary mt-1">
                  Your payment is processed securely through Cashfree Payment Gateway with bank-level encryption. 
                  All transactions are PCI DSS compliant and your card details are never stored.
                </p>
              </div>
            </div>
          </Card.Content>
