      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-semibold text-duo-primary">{title}</h1>
              {user && (
                <p className="text-sm text-duo-text-secondary">Welcome, {user.name}</p>
              )}
            </div>
          </div>
            ...
            {user && (
              <div className="flex items-center space-x-3">
                <div className="text-right">
                  <p className="text-sm font-medium text-duo-text-primary">Current Balance</p>
                  <div className="flex items-center space-x-1">
                    <span className="text-lg font-semibold text-duo-primary">₹{user.coins || 0}</span>
                    <span className="text-sm text-duo-text-secondary">coins</span>
                  </div>
                </div>
